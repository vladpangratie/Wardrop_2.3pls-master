...
public class MemoryDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + MemoryContract.MemoryEntry.TABLE_NAME + " (" +
                    ...
                    MemoryContract.MemoryEntry.COLUMN_COLOR + TEXT_TYPE + COMMA_SEP +
                    MemoryContract.MemoryEntry.COLUMN_CATEGORY + TEXT_TYPE + COMMA_SEP +
                    MemoryContract.MemoryEntry.COLUMN_STYLE + TEXT_TYPE + COMMA_SEP +
    ...
    public boolean addMemory(Memory memory) {
        ...
        values.put(MemoryContract.MemoryEntry.COLUMN_COLOR, memory.getColor());
        values.put(MemoryContract.MemoryEntry.COLUMN_CATEGORY, memory.getCategory());
        values.put(MemoryContract.MemoryEntry.COLUMN_STYLE, memory.getStyle());
